...
public class RealtimeDatabaseActivity extends AppCompatActivity {
    ...
    private void getRealtimeValue() { // https://project-id-default-rnd.asia-southeast1.firebasedatabase.app/
        FirebaseDatabase database = FirebaseDatabase.getInstance("https://fir-demo-fd51d-default-rtdb.asia-southeast1.firebasedatabase.app/");
    ...
    private void useRealtimeDatabase(String content) { // https://project-id-default-rnd.asia-southeast1.firebasedatabase.app/
        FirebaseDatabase database = FirebaseDatabase.getInstance("https://fir-demo-fd51d-default-rtdb.asia-southeast1.firebasedatabase.app/");
        DatabaseReference ref = database.getReference("messages");
